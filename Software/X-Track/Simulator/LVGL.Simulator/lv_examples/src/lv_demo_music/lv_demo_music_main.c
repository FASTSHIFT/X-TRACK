...
lv_obj_t * _lv_demo_music_main_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_grid_cell(title_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_ALIGN_CENTER, 1, 1);
    lv_obj_set_grid_cell(icon_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_ALIGN_CENTER, 3, 1);
    lv_obj_set_grid_cell(spectrum_obj, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 5, 1);
    lv_obj_set_grid_cell(ctrl_box, LV_GRID_ALIGN_STRETCH, 0, 1, LV_ALIGN_CENTER, 7, 1);
    ...
    lv_obj_align(title, LV_ALIGN_LEFT_MID, 50, -10);
#else
...
static lv_obj_t * create_cont(lv_obj_t * parent)
{
    /*A transparent ontainer in which the player section will be scrolled*/
...
static lv_obj_t * create_ctrl_box(lv_obj_t * parent)
{
    ...
    lv_obj_align(icon, LV_ALIGN_TOP_MID, -95, 27);
    ...
    lv_obj_align(icon, LV_ALIGN_TOP_MID, -45, 7);
    ...
    lv_obj_align(play_obj, LV_ALIGN_TOP_MID, 0, 0);
    ...
    lv_obj_set_size(slider_obj, lv_obj_get_width(cont) - 50, 3);
    lv_obj_align(slider_obj, LV_ALIGN_TOP_LEFT, 10, 82);
#elif LV_DEMO_MUSIC_LANDSCAPE
    lv_obj_set_size(slider_obj, lv_obj_get_width(cont) - 50, 3);
    lv_obj_align(slider_obj, LV_ALIGN_TOP_LEFT, 10, 82);
#else
    lv_obj_set_size(slider_obj, 210, 3);
    lv_obj_align(slider_obj, LV_ALIGN_TOP_MID, -10, 82);
#endif
    ...
    lv_obj_align(time_obj, LV_ALIGN_TOP_RIGHT, -1, 75);
...
static lv_obj_t * create_handle(lv_obj_t * parent)
{
    lv_obj_t * cont = lv_obj_create(parent);
    lv_obj_remove_style_all(cont);
    lv_obj_align(cont, LV_ALIGN_BOTTOM_MID, 0, -35);
    ...
    lv_obj_align(handle_label, LV_ALIGN_TOP_MID, 0, 0);

    lv_obj_t * handle_rect = lv_obj_create(cont);
    lv_obj_set_size(handle_rect, 20, 2);
    lv_obj_align(handle_rect, LV_ALIGN_TOP_MID, 0, 20);
...
#else
    lv_coord_t x = lv_obj_get_x(album_img_obj);
    if(next) {
