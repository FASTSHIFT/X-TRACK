...
#if defined(USE_HSE)
#define CLK_SRC_VALUE HSE_VALUE
#else
#define CLK_SRC_VALUE HSI_VALUE
#endif

/************************* PLL Parameters *************************************/
/* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
#define PLL_M      (CLK_SRC_VALUE/1000000)
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || defined(STM32F401xx) || defined(STM32F410xx) || defined(STM32F411xE) || defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F446xx) || defined(STM32F469_479xx)
      if (pllsource != 0)
      {
...
#endif /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx || STM32F401xx || STM32F411xE || STM32F412xG || STM32F413_423xx ||  STM32F446xx || STM32F469_479xx */
...
static void SetSysClock_f411xe(void) {
...
#if defined(STM32F446xx)
static void SetSysClock_f446xx(void) {
  __IO uint32_t StartUpCounter = 0, HSEStatus = 0;
...
static void SetSysClock_f429xx(void)
{
  __IO uint32_t StartUpCounter = 0, HSEStatus = 0;
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F412xG) || defined(STM32F413_423xx) || defined(STM32F469_479xx)
/******************************************************************************/
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F412xG) || defined(STM32F469_479xx)    
    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;
    
    /* PCLK1 = HCLK / 4*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;
#endif /* STM32F40_41xxx || STM32F427_437x  || STM32F412xG || STM32F446xx || STM32F469_479xx */
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F469_479xx)
    /* Configure the main PLL */
    RCC->PLLCFGR = PLL_M | (PLL_N << 6) | (((PLL_P >> 1) -1) << 16) |
                   (RCC_PLLCFGR_PLLSRC_HSE) | (PLL_Q << 24);
...
#if defined(STM32F427_437xx) || defined(STM32F469_479xx)
    /* Enable the Over-drive to extend the clock frequency to 180 Mhz */
    PWR->CR |= PWR_CR_ODEN;
    while((PWR->CSR & PWR_CSR_ODRDY) == 0)
    {
...
#endif /* STM32F40_41xxx || STM32F427_437xx  ||STM32F469_479xx */
}
